                        ...
                        <div class="lg:col-span-3 md:col-span-4">
                            ...
                            <ul class="list-none footer-list mt-6">
                                ...
                                <li class="mt-[10px]"><a href="widget.html"
                                        class="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i
                                            class="uil uil-angle-right-b me-1"></i> Widget</a></li>
                            </ul>
                        </div>
                        <!--end col-->
                            ...
                            <form>
                                <div class="grid grid-cols-1">
                                    ...
                                    <button type="submit" id="submitsubscribe" name="send"
                                        class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">Subscribe</button>
                                </div>
                            </form>
                        </div>
                        <!--end col-->
            ...
            <div class="grid md:grid-cols-2 items-center">
                ...
                <ul class="list-none md:text-right text-center mt-6 md:mt-0">
                    <li class="inline"><a href=""><img
                                src="{{ asset('assets/images/payments/american-ex.png') }}" class="max-h-6 inline"
                                title="American Express" alt=""></a></li>
                    <li class="inline"><a href=""><img
                                src="{{ asset('assets/images/payments/discover.png') }}" class="max-h-6 inline"
                                title="Discover" alt=""></a></li>
                    <li class="inline"><a href=""><img
                                src="{{ asset('assets/images/payments/master-card.png') }}" class="max-h-6 inline"
                                title="Master Card" alt=""></a></li>
                    <li class="inline"><a href=""><img src="{{ asset('assets/images/payments/paypal.png') }}"
                                class="max-h-6 inline" title="Paypal" alt=""></a></li>
                    <li class="inline"><a href=""><img src="{{ asset('assets/images/payments/visa.png') }}"
