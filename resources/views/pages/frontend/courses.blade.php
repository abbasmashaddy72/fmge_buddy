            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
                ...
                <div
                    ...
                    <div class="content p-6 relative">
                        <a href="{{ route('course_detail') }}" class="font-medium block text-indigo-600">Digital
                            Marketing</a>
                        <a href="{{ route('course_detail') }}"
                            class="text-lg font-medium block hover:text-indigo-600 duration-500 ease-in-out mt-2">Starting
                            SEO as your Home Based Business</a>
                        <p class="text-slate-400 mt-3 mb-4">The phrasal sequence of the is now so that many campaign and
                            benefit</p>
                        ...
                        <ul
                            ...
                            <li class="flex items-center mr-4">
                                <i
                                    class="uil uil-book-open text-lg leading-none mr-2 text-slate-900 dark:text-white"></i>
                            ...
                            <li class="flex items-center">
                                <i class="uil uil-eye text-lg leading-none mr-2 text-slate-900 dark:text-white"></i>
                                <span>3012</span>
                            </li>
                        </ul>

                        <div
                            class="absolute -top-7 right-6 z-1 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                            <div
                                class="flex justify-center items-center w-14 h-14 bg-white dark:bg-slate-900 rounded-full shadow-lg dark:shadow-gray-800 text-indigo-600 dark:text-white">
                ...
                <div
                        ...
                        <div
                            ...
                            <div class="pb-4 pl-4 flex items-center">
                                <img src="{{ asset('assets/images/client/02.jpg') }}"
                                    ...
                                    alt="">
                                <div class="ml-3">
                                    <a href="" class="font-semibold text-white block">Christa Smith</a>
                                    <span class="text-white/70 text-sm">Professor</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content p-6 relative">
                        ...
                        <a href="{{ route('course_detail') }}"
                            class="text-lg font-medium block hover:text-indigo-600 duration-500 ease-in-out mt-2">Java
                ...
                <div
                        ...
                        <div
                            ...
                            <div class="pb-4 pl-4 flex items-center">
                                <img src="{{ asset('assets/images/client/03.jpg') }}"
                                    ...
                                    alt="">
                                <div class="ml-3">
                                    <a href="" class="font-semibold text-white block">Jani Jangad</a>
                                    <span class="text-white/70 text-sm">Professor</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content p-6 relative">
                        ...
                        <p class="text-slate-400 mt-3 mb-4">The phrasal sequence of the is now so that many campaign
                            and benefit</p>
                ...
                <div
                        ...
                        <div
                            ...
                            <div class="pb-4 pl-4 flex items-center">
                                <img src="{{ asset('assets/images/client/04.jpg') }}"
                                    ...
                                    alt="">
                                <div class="ml-3">
                                    <a href="" class="font-semibold text-white block">John Cartwright</a>
                                    <span class="text-white/70 text-sm">Professor</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content p-6 relative">
                        <a href="{{ route('course_detail') }}" class="font-medium block text-indigo-600">Web
                            Development</a>
                        <a href="{{ route('course_detail') }}"
                            class="text-lg font-medium block hover:text-indigo-600 duration-500 ease-in-out mt-2">Vue -
                            The Complete Guide (w/ Router, Composition API)</a>
                        <p class="text-slate-400 mt-3 mb-4">The phrasal sequence of the is now so that many campaign
                            and benefit</p>
                ...
                <div
                        ...
                        <div
                            ...
                            <div class="pb-4 pl-4 flex items-center">
                                <img src="{{ asset('assets/images/client/05.jpg') }}"
                                    ...
                                    alt="">
                                <div class="ml-3">
                                    <a href="" class="font-semibold text-white block">Sally Short</a>
                                    <span class="text-white/70 text-sm">Professor</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content p-6 relative">
                        <a href="{{ route('course_detail') }}" class="font-medium block text-indigo-600">Front-end
                            Design</a>
                        <a href="{{ route('course_detail') }}"
                            class="text-lg font-medium block hover:text-indigo-600 duration-500 ease-in-out mt-2">HTML,
                            CSS, Javascripts, and Basic Knowledge about web design</a>
                        <p class="text-slate-400 mt-3 mb-4">The phrasal sequence of the is now so that many campaign
                            and benefit</p>
                ...
                <div
                        ...
                        <div
                            ...
                            <div class="pb-4 pl-4 flex items-center">
                                <img src="{{ asset('assets/images/client/06.jpg') }}"
                                    ...
                                    alt="">
                                <div class="ml-3">
                                    <a href="" class="font-semibold text-white block">William Benson</a>
                                    <span class="text-white/70 text-sm">Professor</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content p-6 relative">
                        <a href="{{ route('course_detail') }}" class="font-medium block text-indigo-600">Back-end
                            Development</a>
                        <a href="{{ route('course_detail') }}"
                            class="text-lg font-medium block hover:text-indigo-600 duration-500 ease-in-out mt-2">C
