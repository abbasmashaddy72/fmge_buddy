<x-guest-layout>
    ...
    <div id="all" class="flex flex-no-wrap overflow-x-auto scrolling-touch items-start mb-12 mt-4 justify-center">
        <!-- First Repeater -->
                    ...
                    <div class="px-4 py-2">
                        <div class="text-lg leading-6 font-medium space-y-1">
                            <a href="#{{ strtolower(str_replace(' ', '_', pathinfo($item)['filename'])) }}"
                                ...
                                <input type='radio' id="{{ preg_replace('/[0-9]+/', '', pathinfo($item)['filename']) }}"
                                    hidden value="{{ preg_replace('/[0-9]+/', '', pathinfo($item)['filename']) }}" />
                                <span
