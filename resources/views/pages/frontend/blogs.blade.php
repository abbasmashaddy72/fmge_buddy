<x-guest-layout>
    <x-frontend.breadcrumb title="Blogs" />
        ...
        <div class="container">
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
                ...
                <div class="blog relative rounded-md shadow dark:shadow-gray-800 overflow-hidden">
                    ...
                    <div class="content p-6">
                        <a href="{{ route('blog_detail') }}"
                            class="title h5 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">How apps
                ...
                <div class="blog relative rounded-md shadow dark:shadow-gray-800 overflow-hidden">
                    ...
                    <div class="content p-6">
                        <a href="{{ route('blog_detail') }}"
                            class="title h5 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">Mobile
                            Marketing, Its Synthes and 2021 Offer Prognosis</a>
                        <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and
                            benefit</p>
                ...
                <div class="blog relative rounded-md shadow dark:shadow-gray-800 overflow-hidden">
                    <img src="{{ asset('assets/images/blog/05.jpg') }}" alt="">

                    <div class="content p-6">
                        <a href="{{ route('blog_detail') }}"
                            class="title h5 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">Stop
                            Worrying About Deadlines! We Got You Covered</a>
                        <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and
                            benefit</p>
                ...
                <div class="blog relative rounded-md shadow dark:shadow-gray-800 overflow-hidden">
                    <img src="{{ asset('assets/images/blog/06.jpg') }}" alt="">

                    <div class="content p-6">
                        <a href="{{ route('blog_detail') }}"
                            class="title h5 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">Change
                            Your Strategy: Find a Business Consultant</a>
                        <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and
                            benefit</p>
                ...
                <div class="blog relative rounded-md shadow dark:shadow-gray-800 overflow-hidden">
                    <img src="{{ asset('assets/images/blog/07.jpg') }}" alt="">

                    <div class="content p-6">
                        <a href="{{ route('blog_detail') }}"
                            class="title h5 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">Everything
                            About Financial Modeling</a>
                        <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and
                            benefit</p>
                ...
                <div class="blog relative rounded-md shadow dark:shadow-gray-800 overflow-hidden">
                    <img src="{{ asset('assets/images/blog/08.jpg') }}" alt="">

                    <div class="content p-6">
                        <a href="{{ route('blog_detail') }}"
                            class="title h5 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">On the
                            other hand we provide denounce</a>
                        <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and
                            benefit</p>
